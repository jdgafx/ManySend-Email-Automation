      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-xl">
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            {error && (
              <p className="rounded-lg border border-red-800/50 bg-red-900/30 px-3.5 py-2.5 text-sm text-red-400">
                {error}
              </p>
            )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={cn(
                'flex items-center justify-center gap-2 rounded-lg border border-zinc-700',
                'bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-200',
                'transition hover:border-zinc-600 hover:bg-zinc-700'
              )}
            >
        ...
        <p className="mt-6 text-center text-xs text-zinc-600">Access is by invite only</p>
      </div>
    </div>
  );
}
